program test_eq_transfer
    ...
    subroutine test_real32
        ...
        block
            ...
            if ( .not. eq_transfer(x,y) ) then
                error stop "> NG! ; REQUIRED: .true. / RESULT: .false. @test_eq_transfer.fypp No.18"
            end if
        ...
        block
            ...
            if ( .not. eq_transfer(x,y) ) then
                error stop "> NG! ; REQUIRED: .true. / RESULT: .false. @test_eq_transfer.fypp No.35"
            end if
        ...
        block
            ...
            if ( .not. eq_transfer(x,y) ) then
                error stop "> NG! ; REQUIRED: .true. / RESULT: .false. @test_eq_transfer.fypp No.52"
            end if
        ...
        block
            ...
            if ( .not. eq_transfer(x,y) ) then
                error stop "> NG! ; REQUIRED: .true. / RESULT: .false. @test_eq_transfer.fypp No.69"
            end if
        ...
        block
            ...
            if ( .not. eq_transfer(x,y) ) then
                error stop "> NG! ; REQUIRED: .true. / RESULT: .false. @test_eq_transfer.fypp No.86"
            end if
        ...
        block
            ...
            if ( .not. eq_transfer(x,y) ) then
                error stop "> NG! ; REQUIRED: .true. / RESULT: .false. @test_eq_transfer.fypp No.103"
            end if
        ...
        block
            ...
            if ( .not. eq_transfer(x,y) ) then
                error stop "> NG! ; REQUIRED: .true. / RESULT: .false. @test_eq_transfer.fypp No.120"
            end if
        ...
        block
            ...
            if ( .not. eq_transfer(x,y) ) then
                error stop "> NG! ; REQUIRED: .true. / RESULT: .false. @test_eq_transfer.fypp No.137"
            end if
        ...
        block
            ...
            if ( .not. eq_transfer(x,y) ) then
                error stop "> NG! ; REQUIRED: .true. / RESULT: .false. @test_eq_transfer.fypp No.138"
            end if
        ...
        block
            ...
            if ( .not. eq_transfer(x,y) ) then
                error stop "> NG! ; REQUIRED: .true. / RESULT: .false. @test_eq_transfer.fypp No.154"
            end if
        ...
        block
            ...
            if ( .not. eq_transfer(x,y) ) then
                error stop "> NG! ; REQUIRED: .true. / RESULT: .false. @test_eq_transfer.fypp No.188"
            end if
        ...
        block
            ...
            if ( .not. eq_transfer(x,y) ) then
                error stop "> NG! ; REQUIRED: .true. / RESULT: .false. @test_eq_transfer.fypp No.205"
            end if
        ...
        block
            ...
            if ( .not. eq_transfer(x,y) ) then
                error stop "> NG! ; REQUIRED: .true. / RESULT: .false. @test_eq_transfer.fypp No.239"
            end if
        ...
        block
            ...
            if ( .not. eq_transfer(x,y) ) then
                error stop "> NG! ; REQUIRED: .true. / RESULT: .false. @test_eq_transfer.fypp No.256"
            end if
    ...
    subroutine test_real64
        ...
        block
            ...
            if ( .not. eq_transfer(x,y) ) then
                error stop "> NG! ; REQUIRED: .true. / RESULT: .false. @test_eq_transfer.fypp No.274"
            end if
        ...
        block
            ...
            if ( .not. eq_transfer(x,y) ) then
                error stop "> NG! ; REQUIRED: .true. / RESULT: .false. @test_eq_transfer.fypp No.291"
            end if
        ...
        block
            ...
            if ( .not. eq_transfer(x,y) ) then
                error stop "> NG! ; REQUIRED: .true. / RESULT: .false. @test_eq_transfer.fypp No.308"
            end if
        ...
        block
            ...
            if ( .not. eq_transfer(x,y) ) then
                error stop "> NG! ; REQUIRED: .true. / RESULT: .false. @test_eq_transfer.fypp No.342"
            end if
        ...
        block
            ...
            if ( .not. eq_transfer(x,y) ) then
                error stop "> NG! ; REQUIRED: .true. / RESULT: .false. @test_eq_transfer.fypp No.359"
            end if
        ...
        block
            ...
            if ( .not. eq_transfer(x,y) ) then
                error stop "> NG! ; REQUIRED: .true. / RESULT: .false. @test_eq_transfer.fypp No.376"
            end if
        ...
        block
            ...
            if ( .not. eq_transfer(x,y) ) then
                error stop "> NG! ; REQUIRED: .true. / RESULT: .false. @test_eq_transfer.fypp No.394"
            end if
        ...
        block
            ...
            if ( .not. eq_transfer(x,y) ) then
                error stop "> NG! ; REQUIRED: .true. / RESULT: .false. @test_eq_transfer.fypp No.410"
            end if
        ...
        block
            ...
            if ( .not. eq_transfer(x,y) ) then
                error stop "> NG! ; REQUIRED: .true. / RESULT: .false. @test_eq_transfer.fypp No.427"
            end if
        ...
        block
            ...
            if ( .not. eq_transfer(x,y) ) then
                error stop "> NG! ; REQUIRED: .true. / RESULT: .false. @test_eq_transfer.fypp No.444"
            end if
        ...
        block
            ...
            if ( .not. eq_transfer(x,y) ) then
                error stop "> NG! ; REQUIRED: .true. / RESULT: .false. @test_eq_transfer.fypp No.461"
            end if
        ...
        block
            ...
            if ( .not. eq_transfer(x,y) ) then
                error stop "> NG! ; REQUIRED: .true. / RESULT: .false. @test_eq_transfer.fypp No.478"
            end if
        ...
        block
            ...
            if ( .not. eq_transfer(x,y) ) then
                error stop "> NG! ; REQUIRED: .true. / RESULT: .false. @test_eq_transfer.fypp No.495"
            end if
        ...
        block
            ...
            if ( .not. eq_transfer(x,y) ) then
                error stop "> NG! ; REQUIRED: .true. / RESULT: .false. @test_eq_transfer.fypp No.512"
            end if
    ...
    subroutine test_real128
        ...
        block
            ...
            if ( .not. eq_transfer(x,y) ) then
                error stop "> NG! ; REQUIRED: .true. / RESULT: .false. @test_eq_transfer.fypp No.547"
            end if
        ...
        block
            ...
            if ( .not. eq_transfer(x,y) ) then
                error stop "> NG! ; REQUIRED: .true. / RESULT: .false. @test_eq_transfer.fypp No.564"
            end if
        ...
        block
            ...
            if ( .not. eq_transfer(x,y) ) then
                error stop "> NG! ; REQUIRED: .true. / RESULT: .false. @test_eq_transfer.fypp No.581"
            end if
        ...
        block
            ...
            if ( .not. eq_transfer(x,y) ) then
                error stop "> NG! ; REQUIRED: .true. / RESULT: .false. @test_eq_transfer.fypp No.598"
            end if
        ...
        block
            ...
            if ( .not. eq_transfer(x,y) ) then
                error stop "> NG! ; REQUIRED: .true. / RESULT: .false. @test_eq_transfer.fypp No.615"
            end if
        ...
        block
            ...
            if ( .not. eq_transfer(x,y) ) then
                error stop "> NG! ; REQUIRED: .true. / RESULT: .false. @test_eq_transfer.fypp No.632"
            end if
        ...
        block
            ...
            if ( .not. eq_transfer(x,y) ) then
                error stop "> NG! ; REQUIRED: .true. / RESULT: .false. @test_eq_transfer.fypp No.665"
            end if
        ...
        block
            ...
            if ( .not. eq_transfer(x,y) ) then
                error stop "> NG! ; REQUIRED: .true. / RESULT: .false. @test_eq_transfer.fypp No.666"
            end if
        ...
        block
            ...
            if ( .not. eq_transfer(x,y) ) then
                error stop "> NG! ; REQUIRED: .true. / RESULT: .false. @test_eq_transfer.fypp No.683"
            end if
        ...
        block
            ...
            if ( .not. eq_transfer(x,y) ) then
                error stop "> NG! ; REQUIRED: .true. / RESULT: .false. @test_eq_transfer.fypp No.700"
            end if
        ...
        block
            ...
            if ( .not. eq_transfer(x,y) ) then
                error stop "> NG! ; REQUIRED: .true. / RESULT: .false. @test_eq_transfer.fypp No.717"
            end if
        ...
        block
            ...
            if ( .not. eq_transfer(x,y) ) then
                error stop "> NG! ; REQUIRED: .true. / RESULT: .false. @test_eq_transfer.fypp No.734"
            end if
        ...
        block
            ...
            if ( .not. eq_transfer(x,y) ) then
                error stop "> NG! ; REQUIRED: .true. / RESULT: .false. @test_eq_transfer.fypp No.751"
            end if
        ...
        block
            ...
            if ( .not. eq_transfer(x,y) ) then
                error stop "> NG! ; REQUIRED: .true. / RESULT: .false. @test_eq_transfer.fypp No.768"
            end if
