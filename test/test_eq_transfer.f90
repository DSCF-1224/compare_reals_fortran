program test_eq_transfer
    ...
    subroutine test_real32
        ...
        block
            ...
            if ( .not. eq_transfer(x,y) ) then
                error stop "> NG! ; REQUIRED: .true. / RESULT: .false. @test_eq_transfer.fypp No.20"
            end if
        ...
        block
            ...
            if ( .not. eq_transfer(x,y) ) then
                error stop "> NG! ; REQUIRED: .true. / RESULT: .false. @test_eq_transfer.fypp No.39"
            end if
        ...
        block
            ...
            if ( .not. eq_transfer(x,y) ) then
                error stop "> NG! ; REQUIRED: .true. / RESULT: .false. @test_eq_transfer.fypp No.58"
            end if
        ...
        block
            ...
            if ( .not. eq_transfer(x,y) ) then
                error stop "> NG! ; REQUIRED: .true. / RESULT: .false. @test_eq_transfer.fypp No.77"
            end if
        ...
        block
            ...
            if ( .not. eq_transfer(x,y) ) then
                error stop "> NG! ; REQUIRED: .true. / RESULT: .false. @test_eq_transfer.fypp No.96"
            end if
        ...
        block
            ...
            if ( .not. eq_transfer(x,y) ) then
                error stop "> NG! ; REQUIRED: .true. / RESULT: .false. @test_eq_transfer.fypp No.115"
            end if
        ...
        block
            ...
            if ( .not. eq_transfer(x,y) ) then
                error stop "> NG! ; REQUIRED: .true. / RESULT: .false. @test_eq_transfer.fypp No.134"
            end if
        ...
        block
            ...
            if ( .not. eq_transfer(x,y) ) then
                error stop "> NG! ; REQUIRED: .true. / RESULT: .false. @test_eq_transfer.fypp No.153"
            end if
        ...
        block
            ...
            if ( .not. eq_transfer(x,y) ) then
                error stop "> NG! ; REQUIRED: .true. / RESULT: .false. @test_eq_transfer.fypp No.172"
            end if
        ...
        block
            ...
            if ( .not. eq_transfer(x,y) ) then
                error stop "> NG! ; REQUIRED: .true. / RESULT: .false. @test_eq_transfer.fypp No.191"
            end if
        ...
        block
            ...
            if ( .not. eq_transfer(x,y) ) then
                error stop "> NG! ; REQUIRED: .true. / RESULT: .false. @test_eq_transfer.fypp No.192"
            end if
        ...
        block
            ...
            if ( .not. eq_transfer(x,y) ) then
                error stop "> NG! ; REQUIRED: .true. / RESULT: .false. @test_eq_transfer.fypp No.209"
            end if
        ...
        block
            ...
            if ( .not. eq_transfer(x,y) ) then
                error stop "> NG! ; REQUIRED: .true. / RESULT: .false. @test_eq_transfer.fypp No.229"
            end if
        ...
        block
            ...
            if ( .not. eq_transfer(x,y) ) then
                error stop "> NG! ; REQUIRED: .true. / RESULT: .false. @test_eq_transfer.fypp No.248"
            end if
        ...
        block
            ...
            if ( .not. eq_transfer(x,y) ) then
                error stop "> NG! ; REQUIRED: .true. / RESULT: .false. @test_eq_transfer.fypp No.267"
            end if
        ...
        block
            ...
            if ( .not. eq_transfer(x,y) ) then
                error stop "> NG! ; REQUIRED: .true. / RESULT: .false. @test_eq_transfer.fypp No.286"
            end if
        ...
        block
            ...
            if ( .not. eq_transfer(x,y) ) then
                error stop "> NG! ; REQUIRED: .true. / RESULT: .false. @test_eq_transfer.fypp No.305"
            end if
        ...
        block
            ...
            if ( .not. eq_transfer(x,y) ) then
                error stop "> NG! ; REQUIRED: .true. / RESULT: .false. @test_eq_transfer.fypp No.324"
            end if
    ...
    subroutine test_real64
        ...
        block
            ...
            if ( .not. eq_transfer(x,y) ) then
                error stop "> NG! ; REQUIRED: .true. / RESULT: .false. @test_eq_transfer.fypp No.325"
            end if
        ...
        block
            ...
            if ( .not. eq_transfer(x,y) ) then
                error stop "> NG! ; REQUIRED: .true. / RESULT: .false. @test_eq_transfer.fypp No.344"
            end if
        ...
        block
            ...
            if ( .not. eq_transfer(x,y) ) then
                error stop "> NG! ; REQUIRED: .true. / RESULT: .false. @test_eq_transfer.fypp No.363"
            end if
        ...
        block
            ...
            if ( .not. eq_transfer(x,y) ) then
                error stop "> NG! ; REQUIRED: .true. / RESULT: .false. @test_eq_transfer.fypp No.382"
            end if
        ...
        block
            ...
            if ( .not. eq_transfer(x,y) ) then
                error stop "> NG! ; REQUIRED: .true. / RESULT: .false. @test_eq_transfer.fypp No.401"
            end if
        ...
        block
            ...
            if ( .not. eq_transfer(x,y) ) then
                error stop "> NG! ; REQUIRED: .true. / RESULT: .false. @test_eq_transfer.fypp No.420"
            end if
        ...
        block
            ...
            if ( .not. eq_transfer(x,y) ) then
                error stop "> NG! ; REQUIRED: .true. / RESULT: .false. @test_eq_transfer.fypp No.439"
            end if
        ...
        block
            ...
            if ( .not. eq_transfer(x,y) ) then
                error stop "> NG! ; REQUIRED: .true. / RESULT: .false. @test_eq_transfer.fypp No.458"
            end if
        ...
        block
            ...
            if ( .not. eq_transfer(x,y) ) then
                error stop "> NG! ; REQUIRED: .true. / RESULT: .false. @test_eq_transfer.fypp No.477"
            end if
        ...
        block
            ...
            if ( .not. eq_transfer(x,y) ) then
                error stop "> NG! ; REQUIRED: .true. / RESULT: .false. @test_eq_transfer.fypp No.496"
            end if
        ...
        block
            ...
            if ( .not. eq_transfer(x,y) ) then
                error stop "> NG! ; REQUIRED: .true. / RESULT: .false. @test_eq_transfer.fypp No.515"
            end if
        ...
        block
            ...
            if ( .not. eq_transfer(x,y) ) then
                error stop "> NG! ; REQUIRED: .true. / RESULT: .false. @test_eq_transfer.fypp No.516"
            end if
        ...
        block
            ...
            if ( .not. eq_transfer(x,y) ) then
                error stop "> NG! ; REQUIRED: .true. / RESULT: .false. @test_eq_transfer.fypp No.533"
            end if
        ...
        block
            ...
            if ( .not. eq_transfer(x,y) ) then
                error stop "> NG! ; REQUIRED: .true. / RESULT: .false. @test_eq_transfer.fypp No.534"
            end if
        ...
        block
            ...
            if ( .not. eq_transfer(x,y) ) then
                error stop "> NG! ; REQUIRED: .true. / RESULT: .false. @test_eq_transfer.fypp No.553"
            end if
        ...
        block
            ...
            if ( .not. eq_transfer(x,y) ) then
                error stop "> NG! ; REQUIRED: .true. / RESULT: .false. @test_eq_transfer.fypp No.572"
            end if
        ...
        block
            ...
            if ( .not. eq_transfer(x,y) ) then
                error stop "> NG! ; REQUIRED: .true. / RESULT: .false. @test_eq_transfer.fypp No.591"
            end if
        ...
        block
            ...
            if ( eq_transfer(x,y) ) then
                error stop "> NG! ; REQUIRED: .false. / RESULT: .true. @test_eq_transfer.fypp No.602"
            end if
        ...
        block
            ...
            if ( .not. eq_transfer(x,y) ) then
                error stop "> NG! ; REQUIRED: .true. / RESULT: .false. @test_eq_transfer.fypp No.610"
            end if
        ...
        block
            ...
            if ( eq_transfer(x,y) ) then
                error stop "> NG! ; REQUIRED: .false. / RESULT: .true. @test_eq_transfer.fypp No.626"
            end if
        ...
        block
            ...
            if ( .not. eq_transfer(x,y) ) then
                error stop "> NG! ; REQUIRED: .true. / RESULT: .false. @test_eq_transfer.fypp No.629"
            end if
        ...
        block
            ...
            if ( .not. eq_transfer(x,y) ) then
                error stop "> NG! ; REQUIRED: .true. / RESULT: .false. @test_eq_transfer.fypp No.648"
            end if
    ...
    subroutine test_real128
        ...
        block
            ...
            if ( .not. eq_transfer(x,y) ) then
                error stop "> NG! ; REQUIRED: .true. / RESULT: .false. @test_eq_transfer.fypp No.649"
            end if
        ...
        block
            ...
            if ( eq_transfer(x,y) ) then
                error stop "> NG! ; REQUIRED: .false. / RESULT: .true. @test_eq_transfer.fypp No.650"
            end if
        ...
        block
            ...
            if ( .not. eq_transfer(x,y) ) then
                error stop "> NG! ; REQUIRED: .true. / RESULT: .false. @test_eq_transfer.fypp No.668"
            end if
        ...
        block
            ...
            if ( eq_transfer(x,y) ) then
                error stop "> NG! ; REQUIRED: .false. / RESULT: .true. @test_eq_transfer.fypp No.674"
            end if
        ...
        block
            ...
            if ( .not. eq_transfer(x,y) ) then
                error stop "> NG! ; REQUIRED: .true. / RESULT: .false. @test_eq_transfer.fypp No.687"
            end if
        ...
        block
            ...
            if ( eq_transfer(x,y) ) then
                error stop "> NG! ; REQUIRED: .false. / RESULT: .true. @test_eq_transfer.fypp No.698"
            end if
        ...
        block
            ...
            if ( .not. eq_transfer(x,y) ) then
                error stop "> NG! ; REQUIRED: .true. / RESULT: .false. @test_eq_transfer.fypp No.706"
            end if
        ...
        block
            ...
            if ( eq_transfer(x,y) ) then
                error stop "> NG! ; REQUIRED: .false. / RESULT: .true. @test_eq_transfer.fypp No.722"
            end if
        ...
        block
            ...
            if ( .not. eq_transfer(x,y) ) then
                error stop "> NG! ; REQUIRED: .true. / RESULT: .false. @test_eq_transfer.fypp No.725"
            end if
        ...
        block
            ...
            if ( .not. eq_transfer(x,y) ) then
                error stop "> NG! ; REQUIRED: .true. / RESULT: .false. @test_eq_transfer.fypp No.744"
            end if
        ...
        block
            ...
            if ( eq_transfer(x,y) ) then
                error stop "> NG! ; REQUIRED: .false. / RESULT: .true. @test_eq_transfer.fypp No.746"
            end if
        ...
        block
            ...
            if ( .not. eq_transfer(x,y) ) then
                error stop "> NG! ; REQUIRED: .true. / RESULT: .false. @test_eq_transfer.fypp No.763"
            end if
        ...
        block
            ...
            if ( eq_transfer(x,y) ) then
                error stop "> NG! ; REQUIRED: .false. / RESULT: .true. @test_eq_transfer.fypp No.770"
            end if
        ...
        block
            ...
            if ( .not. eq_transfer(x,y) ) then
                error stop "> NG! ; REQUIRED: .true. / RESULT: .false. @test_eq_transfer.fypp No.782"
            end if
        ...
        block
            ...
            if ( eq_transfer(x,y) ) then
                error stop "> NG! ; REQUIRED: .false. / RESULT: .true. @test_eq_transfer.fypp No.794"
            end if
        ...
        block
            ...
            if ( .not. eq_transfer(x,y) ) then
                error stop "> NG! ; REQUIRED: .true. / RESULT: .false. @test_eq_transfer.fypp No.801"
            end if
        ...
        block
            ...
            if ( eq_transfer(x,y) ) then
                error stop "> NG! ; REQUIRED: .false. / RESULT: .true. @test_eq_transfer.fypp No.818"
            end if
        ...
        block
            ...
            if ( .not. eq_transfer(x,y) ) then
                error stop "> NG! ; REQUIRED: .true. / RESULT: .false. @test_eq_transfer.fypp No.820"
            end if
        ...
        block
            ...
            if ( .not. eq_transfer(x,y) ) then
                error stop "> NG! ; REQUIRED: .true. / RESULT: .false. @test_eq_transfer.fypp No.839"
            end if
        ...
        block
            ...
            if ( .not. eq_transfer(x,y) ) then
                error stop "> NG! ; REQUIRED: .true. / RESULT: .false. @test_eq_transfer.fypp No.840"
            end if
        ...
        block
            ...
            if ( eq_transfer(x,y) ) then
                error stop "> NG! ; REQUIRED: .false. / RESULT: .true. @test_eq_transfer.fypp No.842"
            end if
        ...
        block
            ...
            if ( eq_transfer(x,y) ) then
                error stop "> NG! ; REQUIRED: .false. / RESULT: .true. @test_eq_transfer.fypp No.846"
            end if
        ...
        block
            ...
            if ( .not. eq_transfer(x,y) ) then
                error stop "> NG! ; REQUIRED: .true. / RESULT: .false. @test_eq_transfer.fypp No.857"
            end if
        ...
        block
            ...
            if ( .not. eq_transfer(x,y) ) then
                error stop "> NG! ; REQUIRED: .true. / RESULT: .false. @test_eq_transfer.fypp No.858"
            end if
        ...
        block
            ...
            if ( eq_transfer(x,y) ) then
                error stop "> NG! ; REQUIRED: .false. / RESULT: .true. @test_eq_transfer.fypp No.866"
            end if
        ...
        block
            ...
            if ( .not. eq_transfer(x,y) ) then
                error stop "> NG! ; REQUIRED: .true. / RESULT: .false. @test_eq_transfer.fypp No.877"
            end if
        ...
        block
            ...
            if ( eq_transfer(x,y) ) then
                error stop "> NG! ; REQUIRED: .false. / RESULT: .true. @test_eq_transfer.fypp No.890"
            end if
        ...
        block
            ...
            if ( eq_transfer(x,y) ) then
                error stop "> NG! ; REQUIRED: .false. / RESULT: .true. @test_eq_transfer.fypp No.891"
            end if
        ...
        block
            ...
            if ( .not. eq_transfer(x,y) ) then
                error stop "> NG! ; REQUIRED: .true. / RESULT: .false. @test_eq_transfer.fypp No.896"
            end if
        ...
        block
            ...
            if ( eq_transfer(x,y) ) then
                error stop "> NG! ; REQUIRED: .false. / RESULT: .true. @test_eq_transfer.fypp No.913"
            end if
        ...
        block
            ...
            if ( eq_transfer(x,y) ) then
                error stop "> NG! ; REQUIRED: .false. / RESULT: .true. @test_eq_transfer.fypp No.914"
            end if
        ...
        block
            ...
            if ( .not. eq_transfer(x,y) ) then
                error stop "> NG! ; REQUIRED: .true. / RESULT: .false. @test_eq_transfer.fypp No.915"
            end if
        ...
        block
            ...
            if ( eq_transfer(x,y) ) then
                error stop "> NG! ; REQUIRED: .false. / RESULT: .true. @test_eq_transfer.fypp No.938"
            end if
        ...
        block
            ...
            if ( .not. eq_transfer(x,y) ) then
                error stop "> NG! ; REQUIRED: .true. / RESULT: .false. @test_eq_transfer.fypp No.953"
            end if
        ...
        block
            ...
            if ( eq_transfer(x,y) ) then
                error stop "> NG! ; REQUIRED: .false. / RESULT: .true. @test_eq_transfer.fypp No.962"
            end if
        ...
        block
            ...
            if ( .not. eq_transfer(x,y) ) then
                error stop "> NG! ; REQUIRED: .true. / RESULT: .false. @test_eq_transfer.fypp No.972"
            end if
